 ...
 */
public class AuthOwner extends AEDomainObject implements Owner {
    
	/**
	 * 
	 */
	private static final long serialVersionUID = -516839527944341091L;
	
	private Group ownerGroup;

	public AuthOwner() {
		super(DomainModel.DomainClass.AuthOwner);
	}
	
    public AuthOwner(Principal owner) {
    	this();
        ownerGroup = new AuthRole("AclOwners");
